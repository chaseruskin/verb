...
class Test(ut.TestCase):
    ...
    def test_signal_get_set(self):
        ...
        self.assertEqual(d.get(), Logic('0010'))
    ...
    def test_2d_signal_get(self):
        ...
        self.assertEqual(d.slice(1), Logic('01'))
        self.assertEqual(d.slice(2), Logic('10'))
        self.assertEqual(d.slice((2, 1)), Logic('1'))
        self.assertEqual(d.slice((2, 0)), Logic('0'))
        pass
    ...
    def test_2d_signal_set(self):
        ...
        d.splice(1, '01')
        self.assertEqual(d.get(), Logic('00000100'))
        d.splice(2, '10')
        self.assertEqual(d.get(), Logic('00100100'))
        d.splice(3, '11')
        self.assertEqual(d.get(), Logic('11100100'))
        d.splice(0, '00')
        self.assertEqual(d.get(), Logic('11100100'))

        d.splice((2, 1), '0')
        self.assertEqual(d.get(), Logic('11000100'))
        d.splice((2, 0), 1)
        self.assertEqual(d.get(), Logic('11010100'))
        pass
    ...
    def test_operators(self):
        ...
        d = Signal(4, 0b0110)
        e = ~d
        self.assertEqual(e.get(), Logic('0b1001'))
        self.assertEqual(d.get(), Logic('0b0110'))
        # or 
        f = d | 0b1001
        ...
        i = h >> 2
        self.assertEqual(Logic(i), 0b0011)

        h = Signal(4, 0b1100, signed=1)
        i = h >> 2
        self.assertEqual(Logic(i), 0b1111)
